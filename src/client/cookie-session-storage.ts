...
export class CookieSessionStorage implements SessionStorage {
  ...
  public discard(): void {
    // The cookie stays. It belongs to the domain rather than to this origin, and a
    // sibling may have written it a moment ago for a session that is perfectly
    // good; taking it away would tell that sibling its session had gone.
    this.#local.remove();
    this.#fire();
  }
